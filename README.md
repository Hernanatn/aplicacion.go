...
La librería se presenta aún en versión preliminar - distribución `v 0.4.3`, no está particularmente optimizada y puede presentar errores.

[![Hecho por Chaska](https://img.shields.io/badge/hecho_por-Ch'aska-303030.svg)](https://cajadeideas.ar)
[![Versión: v0.4.3](https://img.shields.io/badge/version-v0.4.3-orange.svg)](https://github.com/hernanatn/github.com/hernanatn/aplicacion.go/releases/latest)
[![Verisón de Go: 1.22.5](https://img.shields.io/badge/Go-1.22.5-blue?logo=go)](https://go.dev/doc/go1.22)
[![GOPKG](https://img.shields.io/badge/Go-pkg-blue?logo=go)](https://pkg.go.dev/github.com/hernanatn/aplicacion.go@v0.4.3)
